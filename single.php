...
<ol class="rater rater-usable">
	<?php for ($i = 1; $i <= 5; $i++) : ?>
	<li class="rater-level"><a href="rate.php?id=<?php echo $garden['id']; ?>&rate=<?php echo $i; ?>">img src="images/rater_carrot.png" width="24" height="40" alt="carrot used to rate the garden"</a></li>
	<?php endfor; ?>
</ol>
