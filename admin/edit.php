...
/**
  *To edit a page to open-data-app*
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (empty($errors)) {
		$sql = $db->prepare('
			UPDATE gardens
			SET name = :name, longitude = :longitude, latitude = :latitude, street_address = :street_address
			WHERE id = :id
		');
...
<head>
	<meta charset="utf-8">
	<title><?php echo $name; ?> &middot; Edit Garden</title>
